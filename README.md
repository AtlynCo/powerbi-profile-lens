...
cover profile-only and period/series views, bound WGS84 points, world countries, all packaged US
states and counties, report-selection integration, six-profile rendering, and normalization. Its
semantic model is only a synthetic DAX
