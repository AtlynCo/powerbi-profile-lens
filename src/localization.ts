...
export const DEFAULT_STRINGS = {
    ...
    Navigation_GestureHelp: "Drag to pan. At geographic Home, scroll to pan (Shift plus wheel moves horizontally); use Ctrl plus scroll or pinch to zoom. After leaving Home, scroll zooms. The page scrolls at pan and zoom limits. Use Shift plus Arrow to pan, plus or minus to zoom, and Home to reset.",
    Period_Label: "Period",
    Legend_Label: "Series",
    ...
    Empty_Guidance_MoveProbe: "Drag the map so the center probe sits over a region that has data, or set a fallback Entity key.",
    Empty_Guidance_Unloaded: "Load more detail for this feature, or move the center probe to a feature that is already loaded.",
    Empty_Guidance_NoValues: "Adjust the report filters so the selected entity has profile values.",
    ...
    Format_HomeView: "Home view",
    Format_HomeView_Description: "Automatic fills geographic contexts and fits generated or non-navigable contexts. Fit shows the full extent; Fill starts closer while keeping Minimum zoom reachable.",
    Format_HomeView_Automatic: "Automatic",
    Format_HomeView_Fit: "Fit",
    Format_HomeView_Fill: "Fill",
    Format_HomeFocus: "Home focus",
    Format_HomeFocus_Description: "Automatic centers Home on a bound Entity that has profile data so the center probe opens on a populated profile. Scene center keeps the previous geometric center of the whole context.",
    Format_HomeFocus_Automatic: "Automatic",
    Format_HomeFocus_DataBearing: "Bound data",
    Format_HomeFocus_SceneCenter: "Scene center",
    ...
    Format_ReferenceDetail: "Reference map detail",
    Format_ReferenceDetail_None: "None",
    Format_ReferenceDetail_Standard: "Standard",
    Format_ReferenceDetail_Full: "Full",
    Format_ShowPhysicalLayers: "Show land and water",
    Format_ShowMapLabels: "Show map labels",
    Format_LabelDensity: "Map label density",
    Format_LabelDensity_Sparse: "Sparse",
    Format_LabelDensity_Balanced: "Balanced",
    Format_LabelDensity_Detailed: "Detailed",
    Format_ShowGraticule: "Show graticule",
