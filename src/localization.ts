...
export const DEFAULT_STRINGS = {
    ...
    Navigation_ProbeDescription: "The fixed center probe marks the viewport center and does not change the focused entity in this version.",
    ...
    Format_NavigationEnabled: "Enable viewport navigation",
