...
export const DEFAULT_STRINGS = {
    ...
    Context_SelectionRejected: "Power BI rejected the Entity selection. Local probe focus is unchanged.",
    ...
    Diagnostic_HostSelectionRejected: "Power BI rejected the Entity selection. Local probe focus is unchanged.",
