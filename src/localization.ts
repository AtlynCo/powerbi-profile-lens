...
export const DEFAULT_STRINGS = {
    ...
    Navigation_GestureHelp: "Drag to pan. Scroll or pinch to zoom (page scrolls when zoom limits are reached). Use Shift plus Arrow to pan, plus or minus to zoom, and Home to reset.",
    Period_Label: "Period",
    Legend_Label: "Series",
