...
points, simple bound polygons, world countries, US states/equivalents, and US
counties/equivalents. Its semantic model is only a synthetic DAX `DATATABLE`; every metric is openly
synthetic. It has no data source, credentials, refresh, upload, or network dependency.
...
logic, interaction call counts, accessibility semantics, lifecycle, package reproducibility, and
